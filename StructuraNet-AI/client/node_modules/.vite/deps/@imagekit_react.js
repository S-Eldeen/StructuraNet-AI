...
var buildTransformationString = function(transformation) {
...
var DEFAULT_DEVICE_BREAKPOINTS = [640, 750, 828, 1080, 1200, 1920, 2048, 3840];
...
function getResponsiveImageAttributes(opts) {
  ...
  const srcSet = candidates.map((w, i) => `${buildURL(w)} ${descriptorKind === "w" ? w : i + 1}${descriptorKind}`).join(", ") || void 0;
  const finalSizes = sizes ?? (descriptorKind === "w" ? "100vw" : void 0);
  return {
...
function computeCandidateWidths(params) {
  ...
  const unique = Array.from(/* @__PURE__ */ new Set([nearest(explicitWidth), nearest(explicitWidth * 2)]));
  return {
    candidates: unique,
    descriptorKind: "x"
  };
...
var ImageKitInvalidRequestError = class extends Error {
...
var ImageKitAbortError = class extends Error {
...
var ImageKitUploadNetworkError = class extends Error {
  constructor(message) {
    super(message);
    this.name = "ImageKitUploadNetworkError";
  }
};
var ImageKitServerError = class extends Error {
  constructor(message, responseMetadata) {
    super(message);
    this.$ResponseMetadata = void 0;
...
var addResponseHeadersAndBody = (body, xhr) => {
  let response = {
    ...body
  };
...
// node_modules/@imagekit/react/dist/imagekitio-react.esm.js
...
var Image = (props) => {
  const contextValues = (0, import_react.useContext)(ImageKitContext);
  const _a = Object.assign(
    ...
    deviceBreakpoints,
    imageBreakpoints
  } = _a, nonIKParams = __rest(_a, ["transformation", "src", "loading", "queryParameters", "urlEndpoint", "transformationPosition", "sizes", "responsive", "deviceBreakpoints", "imageBreakpoints"]);
  ...
  if (!responsive) {
    ...
    return import_react.default.createElement("img", Object.assign({}, nonIKParams, {
      loading,
  ...
  const {
    ...
    src,
    transformation,
    width: isNaN(widthInt) ? void 0 : widthInt,
    sizes,
    queryParameters,
    urlEndpoint,
    transformationPosition,
...
var Video = (props) => {
  ...
  const _a = Object.assign(
    ...
    urlEndpoint,
    transformationPosition
  } = _a, nonIKParams = __rest(_a, ["transformation", "src", "queryParameters", "urlEndpoint", "transformationPosition"]);
  if (!urlEndpoint || urlEndpoint.trim() === "") {
    if (true) {
      console.error("urlEndpoint is neither provided in this component nor in any parent ImageKitProvider.");
    }
  ...
  return import_react.default.createElement("video", Object.assign({}, nonIKParams, {
    src: finalSrc
  }));
};
export {
...
//# sourceMappingURL=@imagekit_react.js.map

...
const AboutPage = () => {
  ...
  const updateUnderline = useCallback((id) => {
    ...
    if (!btn) return;
    const cRect = navLinksRef.current.getBoundingClientRect();
  ...
  const steps = [
    { n: '01', title: 'Describe Your Network',  desc: 'Type a plain-language prompt describing what you need. Something like "3-tier enterprise network for 500 users with a DMZ, redundant core switches, and separate VLANs for HR, Engineering, and Guest" is all the AI needs to get started.' },
    ...
    { n: '03', title: 'Diagram is Generated',   desc: 'A complete, professional architectural diagram is rendered in seconds. Devices are labeled, layers are clearly separated, connection types are shown, and every design decision is documented alongside the image.' },
    { n: '04', title: 'Refine Iteratively',     desc: 'Follow-up prompts update the design instantly. "Add a second ISP link for redundancy," "move the firewall to the perimeter" — the AI applies changes while explaining the trade-offs of each modification on request.' },
    { n: '05', title: 'Simulate & Validate',    desc: 'Export to GNS3 and test routing convergence, simulate link failures to verify failover, validate security policy enforcement, and measure latency under load — all in a completely safe virtual environment.' },
    { n: '06', title: 'Deploy with Confidence', desc: 'Export the full deployment package: the topology diagram, a complete device inventory, the full IP address plan, VLAN table, and per-device configuration templates ready for the implementation team.' },
  ];

  const usecases = [
    { icon: '🏢', title: 'Enterprise Teams',        desc: 'Design multi-site WANs, campus hierarchical networks, and data center fabrics faster than ever before. Standardize design patterns across the whole engineering team and generate consistent documentation automatically.' },
    { icon: '☁️', title: 'Cloud Engineers',          desc: 'Plan and visualize hybrid cloud topologies connecting on-premises infrastructure with AWS, Azure, or GCP. Model SD-WAN overlays, VPN tunnels, and cloud VPC routing in a single unified diagram.' },
    { icon: '🎓', title: 'Students & Candidates',   desc: 'Instantly generate CCNA, CCNP, and CCIE lab topologies for exam practice — no manual setup, no cable hunting, no hour-long configuration sessions before you can start learning.' },
    { icon: '🔐', title: 'Security Architects',     desc: 'Design zero-trust architectures with proper microsegmentation, model firewall rule sets, validate your security posture visually, and ensure compliance with NIST, CIS, or ISO 27001 frameworks.' },
    { icon: '🏗️', title: 'IT Consultants & MSPs',  desc: 'Deliver polished, professional client designs faster than competitors. Generate multiple design alternatives in minutes and adapt them in real time during discovery meetings — no whiteboard required.' },
    ...
    <div className="ap" ref={containerRef}>
            ...
            <svg viewBox="0 0 520 560" className="planet-svg" xmlns="http://www.w3.org/2000/svg">
              <defs>
                ...
                <linearGradient id="rack-g" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="0%" stopColor="#1a2d4a"/><stop offset="100%" stopColor="#0a1828"/>
                </linearGradient>
                <linearGradient id="rack-g2" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="0%" stopColor="#162440"/><stop offset="100%" stopColor="#080f1e"/>
                </linearGradient>
                <linearGradient id="robot-body-g" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="0%" stopColor="#1e3a5f"/><stop offset="100%" stopColor="#0d1f3a"/>
                </linearGradient>
              </defs>
            ...
            <div className="slide-content scrollable">
              <div className="slide-two-col">
                <div className="slide-text-col">
                  ...
                  <p>StructraNet AI eliminates all of that. You describe what your network needs to do — the number of users, the applications it must support, the redundancy requirements, the security boundaries — and the AI produces a complete, professional topology in seconds.</p>
                  ...
                  <p>Engineers can save designs to the cloud, share them with teammates via a permanent link, and reuse proven templates across multiple projects. The result is dramatically faster design cycles, fewer planning errors, and documentation that actually stays current.</p>
                </div>
          ...
          <div className="slide-inner">
            <div className="slide-content scrollable">
              <div className="slide-header">
                ...
                <h2>From Prompt to Deployment in 6 Steps</h2>
                <div className="accent-line" />
                <p className="slide-intro">Every network project follows the same painful path: requirements gathering, manual diagramming, peer review, revision cycles, simulation, and finally deployment documentation. StructraNet AI compresses that entire workflow into minutes.</p>
              </div>
          ...
          <div className="slide-inner">
            <div className="slide-content scrollable">
              <div className="slide-header">
                ...
                <div className="accent-line" />
                <p className="slide-intro">Every feature was designed specifically for network engineers — from the way designs are generated to the way they are exported, simulated, and shared with teams.</p>
              </div>
          ...
          <div className="slide-inner">
            <div className="slide-content scrollable">
              <div className="slide-header">
                ...
                <h2>Who Uses StructraNet AI?</h2>
                <div className="accent-line" />
                <p className="slide-intro">StructraNet AI adapts to your context — whether you are designing enterprise infrastructure, studying for a certification, or delivering a client project on a tight deadline.</p>
              </div>
          ...
          <div className="slide-inner">
            <div className="slide-content">
              <div className="mission-inner">
                ...
                <h2 className="mission-quote">"It is like having an expert partner by your side during every step of network planning."</h2>
                <div className="accent-line" style={{ margin: '0 auto 32px' }} />
                <p>StructraNet AI was built because network design was too slow, too manual, and too dependent on senior engineers who should not be spending their most valuable hours drawing boxes and counting subnets. The expertise required to design a good network should be accessible to every engineer.</p>
                <p>We believe the best network engineers are not the ones who can draw the fastest — they are the ones who think clearly about requirements, trade-offs, and risk. StructraNet AI handles the mechanical work so engineers can focus on what actually matters.</p>
      ...
      <div className="side-dots">
        {SECTIONS.map((s, i) => (
          <button
            key={s.id}
            className={`side-dot ${i === currentIdx ? 'active' : ''}`}
            onClick={() => goTo(i)}
            title={s.label}
          />
        ))}
